...
async function run() {
  ...
  let armors2 = {
    ...
    'Exodus Down': {
      Helmet: [1439502385, 4060742749, 3660228214],
      Gauntlets: [56157064, 1539014368, 569251271],
      'Chest Armor': [1316205184, 472691604, 2032811197],
      'Leg Armor': [1157496418, 192377242, 3617024265],
      'Class Item': [569678873, 853736709, 1810569868]
    },
    'Tangled Web': {
